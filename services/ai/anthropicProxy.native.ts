 ...
 * Versão nativa — sempre chama o endpoint Vercel com URL absoluta.
 * Nunca importa @anthropic-ai/sdk (incompatível com React Native).
 */
...
const API_BASE = (process.env.EXPO_PUBLIC_API_URL ?? 'https://argos-blue.vercel.app').replace(/\/$/, '');
